...
export default{
    ...
    created(){
      ...
      this.loading=true
        ...
        console.log(id);
        let Shu = [];
        this.$axios.post("/test/Product/GoodsSearchPageList?cateId=10066",{})
        .then((res)=>{
            console.log(res);
            ...
            // console.log(Shu);
            this.$axios.get('/api/json/reply/UnifyGoodsListReq?HasPromInfo=true&HasSaleInfo=true&SourceTypeSysNo=2&DisplayLabel=["8"]&ClientIp=61.144.97.195&UserId=0&GoodsID=60'+Shu,{})
            .then((res)=>{
                console.log(res);
                let urll=[];
                let shuJu = res.data.UnifyGoodsList.slice(1);
